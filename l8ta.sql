...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.1&nocache=2489704913ltr&server=1">
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/printview.css?v=5.1.1" media="print" id="printcss">
    <title>localhost / localhost | phpMyAdmin 5.1.1</title>
  ...
  <script data-cfasync="false" type="text/javascript" src="js/dist/export_output.js?v=5.1.1"></script>
...
CommonParams.setAll({common_query:"",opendb_url:"index.php?route=/database/structure",lang:"en",server:"1",table:"",db:"",token:"2e443575557e373b5f4a7a2a25275936",text_dir:"ltr",show_databases_navigation_as_tree:true,pma_text_default_tab:"Browse",pma_text_left_default_tab:"Structure",pma_text_left_default_tab2:false,LimitChars:"50",pftext:"P",confirm:true,LoginCookieValidity:"1440",session_gc_maxlifetime:"1440",logged_in:true,is_https:false,rootPath:"/phpmyadmin/",arg_separator:"&",PMA_VERSION:"5.1.1",auth_type:"config",user:"root"});
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=l8ta&table=product">`l8ta`.`product`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=l8ta&table=images">`l8ta`.`images`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=l8ta&table=categories">`l8ta`.`categories`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=l8ta&table=sub_categories">`l8ta`.`sub_categories`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=l8ta&table=branches">`l8ta`.`branches`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=l8ta&table=bookmarks">`l8ta`.`bookmarks`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=l8ta&table=users">`l8ta`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=l8ta&table=cities">`l8ta`.`cities`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=l8ta&table=views">`l8ta`.`views`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=l8ta&table=area">`l8ta`.`area`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="2e443575557e373b5f4a7a2a25275936">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="l8ta" targettable="product">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `product`  
ORDER BY `product`.`ID` ASC</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="l8ta" targettable="product">
                            <div class="action_content">
...
ORDER BY `product`.`ID`  DESC</span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `product` ORDER BY `ID`  DESC </span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="l8ta" targettable="product">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `product` ORDER BY `ID`  DESC </span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="l8ta" targettable="images">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `images`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="l8ta" targettable="product">
                            <div class="action_content">
